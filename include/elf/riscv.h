...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_GPREL_HI20, 61)
  RELOC_NUMBER (R_RISCV_GPREL_LO12_I, 62)
  RELOC_NUMBER (R_RISCV_GPREL_LO12_S, 63)
  RELOC_NUMBER (R_RISCV_GPREL_ADD, 64)
  RELOC_NUMBER (R_RISCV_GPREL_LOAD, 65)
  RELOC_NUMBER (R_RISCV_GPREL_STORE, 66)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_HI20, 67)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_LO12_I, 68)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_ADD, 69)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_LOAD, 70)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_STORE, 71)
  RELOC_NUMBER (R_RISCV_TLS_GOT_GPREL_HI20, 72)
  RELOC_NUMBER (R_RISCV_TLS_GOT_GPREL_LO12_I, 73)
  RELOC_NUMBER (R_RISCV_TLS_GOT_GPREL_ADD, 74)
  RELOC_NUMBER (R_RISCV_TLS_GD_GPREL_HI20, 75)
  RELOC_NUMBER (R_RISCV_TLS_GD_GPREL_LO12_I, 76)
  RELOC_NUMBER (R_RISCV_TLS_GD_GPREL_ADD, 77)
  RELOC_NUMBER (R_RISCV_64_PCREL, 78)
  RELOC_NUMBER (R_RISCV_PLT_GPREL_HI20, 79)
  RELOC_NUMBER (R_RISCV_PLT_GPREL_LO12_I, 80)
  RELOC_NUMBER (R_RISCV_PLT_GPREL_ADD, 81)
